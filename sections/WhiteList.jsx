...
const setWhitelisting = () => {
  toast.success("Account whitelisted successfully");
};
        ...
        <div className="w-1/2 p-5 px-5 border border-solid border-slate-300 text-black ">
          <form onSubmit={handleSubmit}>
            <div className="relative pb-3">
              <div className="text-white px-2 md:px-0 flex">
                Your Name{" "}
                {<FaStarOfLife size={6} className="text-red-600 mt-1 mx-2" />}
              </div>
              <div className=" ">
            ...
            <div className="relative mt-3 rounded-xl ">
              <div className="text-white px-2 md:px-0 flex">Email</div>
              <div className=" ">
                <input
                  type="text"
                  id="email"
            ...
            <div className="my-5 flex justify-center align-items-center">
              <button
                type="submit"
                onClick={(e) => setWhitelisting()}
                className="bg-orange-500  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-black text-xl font-bold px-5 py-3 rounded-full hover:bg-orange-600"
              >
                LET'S GO
              </button>
              <ToastContainer />
